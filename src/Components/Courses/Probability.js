...
export default function Probability(){
    ...
    const [lessonAttributes]=useState([{
      id:"0",  
      title:"Intro to theoretical probability",
      link:"https://youtube.com/embed/uzkc-qNVoOk",
      /*id:"at"his.props.id,*/
    ...
    },
    {
        ...
        link:"https://youtube.com/embed/Xp6V_lO1ZKA",
        /*id:"at"his.props.id,*/
    ...
    },
    {
        ...
        link:"https://youtube.com/embed/KFgvOQtH0Z0",
        /*id:"at"his.props.id,*/
        status:false,//3 suali da duz yazibsa ulduz almagi,yazmayibsa almamagi ucundu
        questions:[{problem:"Solve for x: 2x+7<5 and x+3\u22650",answer:["x=7","x\u2208(-3,1)","x\u2208(-2,1)"],correct:"B"},{problem:"Solve for y: 3x-91>-87 or 21x-17>25",answer:["x>4\xF73","x<23","x>3"],correct:"A"},{problem:"Solve for x:3x-8\u226423 and -4x+26\u22656",answer:["x>3","x\u22655","x\u226417"],correct:"B"}] //props-dan question adli massivi cekecek
    }
]);
