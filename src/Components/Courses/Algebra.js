...
export default function Algebra(){
    ...
    const [lessonAttributes]=useState([{
      id:"0",  
      title:"Functions",
      link:"https://www.youtube.com/embed/Id6UovYjd-M",
      /*id:"at"his.props.id,*/
      status:/*false*/0,//3 suali da duz yazibsa ulduz almagi,yazmayibsa almamagi ucundu
      questions:[{problem:"Evaluate f(x)=49-x\xB2 at x=5:",answer:["14","24","32"],correct:"B"},{problem:"Evaluate f(x)=x\xB3-1 at x=3:",answer:["26","11","34"],correct:"A"},{problem:"Given that g(x,y)=2x\xB2y+xy+1, g(3,1)=?",answer:["34","21","22"],correct:"C"}], //props-dan question adli massivi cekecek
    ...
    },
    {
        ...
        link:"https://www.youtube.com/embed/lZfXc4nHooo",
        /*id:"at"his.props.id,*/
    ...
    },
    {
        ...
        link:"https://www.youtube.com/embed/d2cnQ5ahHgE",
        /*id:"at"his.props.id,*/
        status:false,//3 suali da duz yazibsa ulduz almagi,yazmayibsa almamagi ucundu
